...
- **Markdown all the way down** — 章程、身份、技能、規則、31 個管線提示詞、7 個 view 種子全部以 Markdown 形式存在於 `$MOLTBOOK_HOME/` 之下。編輯提示詞改變模式抽取的行為；替換 view 種子調整分類。[自訂 →](docs/CONFIGURATION.md#pipeline-prompts--view-seeds)

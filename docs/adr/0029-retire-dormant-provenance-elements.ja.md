...
ADR-0021 (2026-04-16) は `knowledge.json` に provenance + trust 層を追加した。着地後 audit (`.reports/adr-0021-implementation-audit-20260418.md`) で Provenance 群に schema 宣言だけされ実挙動が伴わない要素が 3 件見つかった。ADR-0028 (2026-04-18) で forgetting / feedback 群を撤回した延長として、本 ADR は Provenance 群の残りの dormant 要素を整理する。
...
- Audit report: `.reports/adr-0021-implementation-audit-20260418.md` (§2.D1, §2.D2, §2.D3, §6)

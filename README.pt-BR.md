...
- *Pivot snapshots reprodutíveis* — cada execução de `distill` empacota o estado completo (manifest + views + constituição + embeddings de centroide), permitindo replay bit a bit de qualquer decisão ([ADR-0020](docs/adr/0020-pivot-snapshots-for-replayability.md)).

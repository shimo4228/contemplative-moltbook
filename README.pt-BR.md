...
- Sem execução de shell, sem acesso arbitrário à rede, sem traversal de filesystem — esse código não existe na codebase. Domínio travado em `moltbook.com` + Ollama local. 3 dependências em runtime: `requests`, `numpy`, `rank-bm25`.
...
- Xu, W., Liang, Z., Mei, K., Gao, H., Tan, J., & Zhang, Y. (2025). *A-MEM: Agentic Memory for LLM Agents.* [arXiv:2502.12110](https://arxiv.org/abs/2502.12110) — indexação dinâmica no estilo Zettelkasten e evolução de memória; informa a reinterpretação de padrões antigos topicamente relacionados quando um padrão novo chega ([ADR-0022](docs/adr/0022-memory-evolution-and-hybrid-retrieval.md)).
...
<details>
<summary><b>Registros de desenvolvimento (12 artigos no dev.to)</b></summary>

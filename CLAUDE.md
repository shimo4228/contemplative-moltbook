...
~/.config/moltbook/     # ランタイムデータ (MOLTBOOK_HOME, ユーザー固有)
  ...
  knowledge.json      # 蒸留済みパターン (embedding + gated 列, ADR-0019)
...
942 tests 全パス (2026-04-15)。カバレッジ詳細は [docs/CODEMAPS/INDEX.md](docs/CODEMAPS/INDEX.md) を参照。
